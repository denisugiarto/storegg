        ...
        <div className="content pt-50 pb-30 ps-30">
          ...
          <div className="menus">
            ...
            <div className="item mb-30">
              ...
              <p className="item-title m-0">
                <a href="/member/messages" className="text-lg text-decoration-none">Messages</a>
              </p>
            </div>
            <div className="item mb-30">
              <svg
              ...
              <p className="item-title m-0">
                <a href="/member" className="text-lg text-decoration-none">Card</a>
              </p>
            </div>
            <div className="item mb-30">
              <svg
              ...
              <p className="item-title m-0">
                <a href="/member" className="text-lg text-decoration-none">Rewards</a>
              </p>
            </div>
            <div className="item mb-30">
              <svg
            ...
            <div className="item mb-30">
              ...
              <p className="item-title m-0">
                <a href="/member" className="text-lg text-decoration-none">Log Out</a>
              </p>
            </div>
          </div>
        </div>
